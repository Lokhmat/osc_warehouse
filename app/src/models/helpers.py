...
UNATHORIZED_RESPONSE = {401: {"model": ErrorResponse}}

BAD_REQUEST_RESPONSE = {**UNATHORIZED_RESPONSE, 400: {"model": ErrorResponse}}
NOT_FOUND_RESPONSE = {**UNATHORIZED_RESPONSE, 404: {"model": ErrorResponse}}
